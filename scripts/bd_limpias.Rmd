...
```{r}
variables_modelo <- c("Pobre", "Clase", "Dominio", "P5000", "P5010", "P5090",
                      "P5100", "P5130", "P5140", "Nper", "Depto", "suma_antiguedad", 
...
```{r}
model_tree <- Pobre ~ Clase + Dominio + P5000 + P5010 + P5090 + P5100 + P5130 + 
  P5140 + Nper + Depto + suma_antiguedad + promedio_antiguedad + 
